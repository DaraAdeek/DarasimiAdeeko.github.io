# DarasimiAdeeko.githu<!DOCTYPE html>
<html>
  <head>
  ...
  <button><a href="#coding">Coding</a></button>
  <button><a href="https://www.canva.com" target="_blank">Graphic Desgin</a></button>
  <button><a href="#robotics">Robotics</a></button>
      </ul>
    </nav>
      ...
      <h2 style="color:SlateBlue;">Graphic Design</h2>
